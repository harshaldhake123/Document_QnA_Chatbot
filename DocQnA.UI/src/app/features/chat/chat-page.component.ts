...
export class ChatPageComponent implements OnInit {
    ...
    public readonly isInputEmpty$: Observable<boolean> = this.inputValueSubject$.asObservable().pipe(
    ...
    public ngOnInit(): void {
        ...
        this.messageSend$.pipe(
            ...
            tap((question) => {
                this.messagesSubject$.next([...this.messagesSubject$.value, { text: question, sender: 'user' }]);
            ...
            switchMap((question) => {
                ...
                return this.chatService.queryDocument(docId, question).pipe(
                    map((res) => res.reply),
                    tap((reply) => {
                        this.messagesSubject$.next([...this.messagesSubject$.value, { text: reply, sender: 'assistant' }]);
                    }),
